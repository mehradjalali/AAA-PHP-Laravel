...
<body>
    <div id="huro-app" class="app-wrapper">
            ...
            <div class="container">
                ...
                <div class="navbar-brand">
                    ...
                    <a class="navbar-item is-brand" href="index-3.html">
                        <img class="light-image" src="resources/img/logos/logo/logo.svg" alt="">
                        <img class="dark-image" src="resources/img/logos/logo/logo-light.svg" alt="">
                    </a>
                                            ...
                                            <a class="notification-item">
                                                <div class="img-left">
                                                    <img class="user-photo" alt=""
                                                        ...
                                                        data-demo-src="resources/img/avatars/photos/7.jpg" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="notification-item">
                                                <div class="img-left">
                                                    <img class="user-photo" alt=""
                                                        src="https://via.placeholder.com/150x150"
                                                        data-demo-src="resources/img/avatars/photos/12.jpg" />
                                                </div>
                                                <div class="user-content">
                                        ...
                                        <li>
                                            <a class="notification-item">
                                                <div class="img-left">
                                                    <img class="user-photo" alt=""
                                                        src="https://via.placeholder.com/150x150"
                                                        data-demo-src="resources/img/avatars/photos/13.jpg" />
                                                </div>
                                                <div class="user-content">
                                        ...
                                        <li>
                                            <a class="notification-item">
                                                <div class="img-left">
                                                    <img class="user-photo" alt=""
                                                        src="https://via.placeholder.com/150x150"
                                                        data-demo-src="resources/img/avatars/photos/25.jpg" />
                                                </div>
                                                <div class="user-content">
                            ...
                            <div class="is-trigger" aria-haspopup="true">
                                <div class="profile-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/avatars/photos/8.jpg" alt="">
                                </div>
                            </div>
        ...
        <div id="circular-menu" class="circular-menu">
            ...
            <div class="items-wrapper">
                ...
                <a class="menu-item is-flex right-panel-trigger" data-panel="languages-panel">
                    <img src="resources/img/icons/flags/united-states-of-america.svg" alt="">
                </a>
            ...
            <div class="right-panel">
                ...
                <div class="right-panel-body has-slimscroll">
                    <div class="languages-boxes">
                        ...
                        <div class="language-box">
                            <div class="language-option">
                                <input type="radio" name="language_selection">
                                <div class="language-option-inner">
                                    <img src="resources/img/icons/flags/spain.svg" alt="">
                                    <div class="indicator">
                                        <i data-feather="check"></i>
                                    </div>
                                </div>
                        ...
                        <div class="language-box">
                            <div class="language-option">
                                <input type="radio" name="language_selection">
                                <div class="language-option-inner">
                                    <img src="resources/img/icons/flags/germany.svg" alt="">
                                    <div class="indicator">
                                        <i data-feather="check"></i>
                                    </div>
                                </div>
                        ...
                        <div class="language-box">
                            <div class="language-option">
                                <input type="radio" name="language_selection">
                                <div class="language-option-inner">
                                    <img src="resources/img/icons/flags/mexico.svg" alt="">
                                    <div class="indicator">
                                        <i data-feather="check"></i>
                                    </div>
                                </div>
                        ...
                        <div class="language-box">
                            <div class="language-option">
                                <input type="radio" name="language_selection">
                                <div class="language-option-inner">
                                    <img src="resources/img/icons/flags/china.svg" alt="">
                                    <div class="indicator">
                                        <i data-feather="check"></i>
                                    </div>
                                </div>
                    ...
                    <div class="img-wrap has-text-centered">
                        <img class="light-image" src="resources/img/illustrations/right-panel/languages.svg" alt="">
                        <img class="dark-image" src="resources/img/illustrations/right-panel/languages-dark.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="right-panel-body">
                        <div id="team-side-tab" class="tab-content is-active">
                            ...
                            <div class="team-card">
                                <div class="h-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/avatars/photos/12.jpg" alt="">
                                    <img class="badge" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/icons/flags/united-states-of-america.svg" alt="">
                                </div>
                                <div class="meta">
                                    <span>پاشا</span>
                                    <span>
                            ...
                            <div class="team-card">
                                <div class="h-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/avatars/photos/25.jpg" alt="">
                                    <img class="badge" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/icons/flags/united-states-of-america.svg" alt="">
                                </div>
                                <div class="meta">
                            ...
                            <div class="team-card">
                                <div class="h-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/avatars/photos/18.jpg" alt="">
                                    <img class="badge" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/icons/flags/united-states-of-america.svg" alt="">
                                </div>
                                <div class="meta">
                            ...
                            <div class="team-card">
                                <div class="h-avatar">
                                    <img class="avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/avatars/photos/13.jpg" alt="">
                                    <img class="badge" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/icons/flags/united-states-of-america.svg" alt="">
                                </div>
                                <div class="meta">
                        ...
                        <div id="projects-side-tab" class="tab-content">
                            ...
                            <div class="project-card">
                                <div class="project-inner">
                                    <img class="project-avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/icons/logos/slicer.svg" alt="">
                                    <div class="meta">
                                    ...
                                    <div class="foot-stats">
                                        ...
                                        <div class="avatar-stack">
                                            <div class="h-avatar is-small">
                                                <img class="avatar" src="https://via.placeholder.com/150x150"
                                                    data-demo-src="resources/img/avatars/photos/7.jpg" alt="">
                                            </div>
                                            <div class="h-avatar is-small">
                                                <img class="avatar" src="https://via.placeholder.com/150x150"
                                                    data-demo-src="resources/img/avatars/photos/5.jpg" alt="">
                                            </div>
                                            <div class="h-avatar is-small">
                                                <img class="avatar" src="https://via.placeholder.com/150x150"
                                                    data-demo-src="resources/img/avatars/photos/8.jpg" alt="">
                            ...
                            <div class="project-card">
                                <div class="project-inner">
                                    <img class="project-avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/icons/logos/metamovies.svg" alt="">
                                    <div class="meta">
                            ...
                            <div class="project-card">
                                <div class="project-inner">
                                    <img class="project-avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/icons/logos/fastpizza.svg" alt="">
                                    <div class="meta">
                    ...
                    <div class="recent">
                        ...
                        <div class="recent-block">
                            <a class="media-flex-center">
                                <div class="h-avatar is-small">
                                    <img class="avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/avatars/photos/7.jpg" alt="" data-user-popover="0">
                                </div>
                                <div class="flex-meta">
                                    <span>آلیس</span>
                            ...
                            <a class="media-flex-center">
                                <div class="h-avatar is-small">
                                    <img class="avatar" src="https://via.placeholder.com/150x150"
                                        data-demo-src="resources/img/avatars/photos/22.jpg" alt=""
                                        data-user-popover="5">
                                </div>
                                <div class="flex-meta">
                                    <span>Jimmy H.</span>
        ...
        <script src="resources/js/components.js" async></script>
        <script src="resources/js/popover.js" async></script>
        <script src="resources/js/widgets.js" async></script>


        <!-- Additional Features -->
        <script src="resources/js/touch.js" async></script>
        ...
        <script src="resources/js/syntax.js" async></script>
    </div>
</body>
